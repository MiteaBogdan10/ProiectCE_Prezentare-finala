<nav class="navbar navbar-expand-lg navbar-dark sticky-top bg-dark shadow">
  <div class="container">
    <a href="index.php">
      <img src="../Aladin1/uploads/Aladin-2.png" alt="..." class="rounded float-left" height="60px" width="60px">
   </a>
          ...
          ?>
              ...
              <?= $_SESSION['auth_user']['name']; ?>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="admin/index.php">Go to panel</a></li>
