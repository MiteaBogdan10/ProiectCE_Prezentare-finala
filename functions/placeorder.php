...
if(isset($_SESSION['auth']))
{
  if(isset($_POST['placeOrderBtn']))
  {
        ...
        $query = "SELECT c.id as cid, c.prod_id, c.prod_qty, p.id as pid, p.name, p.image, p.selling_price FROM carts c, products p WHERE 
        c.prod_id=p.id AND c.user_id='$userId' ORDER BY c.id DESC ";
        ...
        $tracking_no = "Bogdi".rand(1111,9999).substr($phone, 2);
